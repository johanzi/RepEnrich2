...
First, perform mapping using Bowtie2 and convert the output in bam format with samtools (example using paired end data):
     ...
     bowtie2 -q -p 16 -x /path/to/annotation/mm9/mm9 -1 /home/Dataset/Sample_L001_R1.fastq -2 /home/Dataset/Sample_L001_R2.fastq | samtools view -bS - > /home/output/sample_mapped.sam
